...
@interface RTGroupViewController ()

@end

@interface RTGroupViewController ()<RTFormViewControllerDelegate>

@end

@implementation RTGroupViewController
...
- (NSArray *)makeForm {
    // 合伙人拍照
    NSError *error = nil;
    NSArray *cellForm = [[RTLabelAndIconModel modelFromRTPartnerJsonPath:@"kPartnerJson3"] objectForKey:@"partnerForm"];
...
- (UIView *)specialHeader {
    RTFormHeaderView *formImg = [[RTFormHeaderView alloc] initWithLeftCornerTitle:@"团队风采多维度照片"];
