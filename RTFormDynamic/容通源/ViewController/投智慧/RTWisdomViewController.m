...
@interface RTWisdomViewController ()

@end

@interface RTWisdomViewController ()<RTFormViewControllerDelegate>

@end

@implementation RTWisdomViewController
...
- (NSArray *)makeForm {
    // 合伙人拍照
    NSError *error = nil;
    NSArray *cellForm = [[RTLabelAndIconModel modelFromRTPartnerJsonPath:@"kPartnerJson5"] objectForKey:@"partnerForm"];
...
- (UIView *)specialHeader {
    RTFormHeaderView *formImg = [[RTFormHeaderView alloc] initWithLeftCornerTitle:@"智慧风采照片"];
