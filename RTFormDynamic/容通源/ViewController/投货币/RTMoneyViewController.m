...
@interface RTMoneyViewController ()

@end

@interface RTMoneyViewController ()<RTFormViewControllerDelegate>

@end

@implementation RTMoneyViewController
...
- (NSArray *)makeForm {
    // 合伙人拍照
    NSError *error = nil;
    NSArray *cellForm = [[RTLabelAndIconModel modelFromRTPartnerJsonPath:@"kPartnerJson1"] objectForKey:@"partnerForm"];
...
- (UIView *)specialHeader {
    RTFormHeaderView *formImg = [[RTFormHeaderView alloc] initWithLeftCornerTitle:@"资金风采投资例证"];
